...
pre-PR checks, or triaging reviewer feedback — per-reviewer routing (CodeRabbit is
label-gated, the other three are automatic), per-branch required checks, the invisible 75%
docstring gate, and the dual ESLint config all live there.
