...
const getEmbeddedWhatsNew = () => {
  return `
    <li><strong>v3.34.08 &ndash; STAK-548: Rename TURSO_DATABASE_URL to SQLD_URL in Poller Code</strong>: Poller env vars renamed to match sqld migration. Local sqld uses <code>SQLD_URL</code>; <code>TURSO_DATABASE_URL</code> becomes an optional Option B for self-hosters running against Turso Cloud as primary. No user-facing behavior change.</li>
