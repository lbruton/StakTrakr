...
const getEmbeddedWhatsNew = () => {
  return `
    <li><strong>v3.35.0 &ndash; STRK-123: Trade linking</strong>: Added bidirectional trade links between disposed traded items and received inventory, with editable provenance, spot-derived trade values, backup/export coverage, and cloud-sync visibility (STRK-123).</li>
