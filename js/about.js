...
const getEmbeddedWhatsNew = () => {
  return `
    ...
    <li><strong>v3.35.36 &ndash; STRK-206/207: Location-filter fix &amp; filter hardening</strong>: Clicking a "Numista Import" location chip no longer filters your inventory to zero. Items imported from Numista have no real purchase or storage location, so they now group under the "&mdash;" placeholder &mdash; just like they already display in the table &mdash; instead of forming a chip that matched nothing. This release also hardens the filtering code's tag lookups and disposed-items filter reset against missing data (STRK-206, STRK-207).</li>  `;
};
