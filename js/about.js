...
const getEmbeddedWhatsNew = () => {
  return `
    <li><strong>v3.36.12 &ndash; STRK-347: Behind-the-scenes tooling for JM Bullion pricing</strong>: An operator-facing maintenance improvement with no change to the app you use. StakTrakr sources JM Bullion prices from FindBullionPrices.com; the internal admin dashboard that manages those price sources now shows the FindBullionPrices page (where the price is read) and the JM Bullion buy link side by side, clearly labeled, and lets them be corrected in place. Nothing about your holdings, prices, or the market comparison changes (STRK-347).</li>
