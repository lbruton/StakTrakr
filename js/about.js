...
const getEmbeddedWhatsNew = () => {
  return `
    <li><strong>v3.35.80 &ndash; STRK-298: Tidying up after the header cleanup</strong>: Nothing changes in the app itself. Retiring the header buttons over the last few releases left behind the styling for the small coloured dot that used to sit in the corner of one of them &mdash; there is no longer any button for it to sit on, and the freshness dot beside the market table uses a different rule on purpose, because the old one would have knocked it out of line. That leftover is now gone. The green, orange and red freshness colours are shared with the market and spot indicators and are untouched (STRK-298).</li>
    <li><strong>v3.35.79 &ndash; STRK-290: The market Refresh button now actually refreshes</strong>: The <strong>&#8635; Refresh</strong> button above the market price table was quietly doing nothing most of the time &mdash; it only fetched new prices if your data was already over an hour old, and any sooner it greyed out, spun for five seconds, put the same prices back and gave no hint that it had skipped the fetch. It now pulls fresh vendor prices every time you click it, and stays in its working state until the fetch genuinely finishes. With that fixed, the <strong>Market</strong> button has left the header, since it did the same job from further away; its green/orange/red freshness dot moved down beside the market table&rsquo;s timestamp, and <strong>Settings &rsaquo; Market &rsaquo; Sync Now</strong> is untouched (STRK-290).</li>
