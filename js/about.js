...
const getEmbeddedWhatsNew = () => {
  return `
    <li><strong>v3.35.74 &ndash; STRK-285/286: Backup and Restore buttons cleared from the header</strong>: These two header buttons did exactly the same thing as each other &mdash; open Settings &rsaquo; System &mdash; so the header was carrying two icons for one action. Both are gone. Nothing about backing up or restoring changed: the full set of CSV, JSON, PDF, and ZIP import/export controls is still in Settings &rsaquo; System where it has always been (STRK-285, STRK-286).</li>
