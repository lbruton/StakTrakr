...
const getEmbeddedWhatsNew = () => {
  return `
    <li><strong>v3.36.29 &ndash; Custom Collection coin side and Slot notes</strong>: Choose whether a Custom Collection shows an Item&rsquo;s obverse or reverse from Edit collection, so the artwork matches the series you are building. Optional Slot notes now appear directly below the year in both Album and Ledger views, and the choice travels with your Collection through sync and backup (STRK-390).</li>
