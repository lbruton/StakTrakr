...
const getEmbeddedWhatsNew = () => {
  return `
    ...
    <li><strong>v3.35.63 &ndash; Goldback stale-data warning now fires correctly</strong>: During a goldback feed outage, the app now correctly shows the stale-data indicator instead of silently displaying hours-old prices. The hourly publish during an outage carries an honest age so the freshness check always trips as designed (STRK-250).</li>
