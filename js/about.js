...
const getEmbeddedWhatsNew = () => {
  return `
    ...
    <li><strong>v3.34.48 &ndash; STRK-47: Sort by Storage Location and Year</strong>: Added <em>Storage Location</em> and <em>Year</em> as virtual sortable options in the card sort bar and Settings default sort selector while keeping both values as inline chips in the Name cell. Year sorts numerically with missing values at the end; Storage Location sorts alphabetically.</li>
  `;
};
