...
const getEmbeddedWhatsNew = () => {
  return `
    ...
    <li><strong>v3.35.51 &ndash; Bulk-convert holdings to constitutional silver</strong>: The Bulk Edit tool can turn a batch of items into junk silver &mdash; enable Type, choose Constitutional, pick a denomination, and apply, and each item gets its correct derived silver content (keeping its existing quantity as the coin count) instead of the $0 melt value bulk conversion previously produced (STRK-238).</li>
