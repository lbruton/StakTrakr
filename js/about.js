...
const getEmbeddedWhatsNew = () => {
  return `
    <li><strong>v3.34.17 &ndash; STAK-437: Remove Search tab, consolidate into Filter Chips</strong>: The Search settings tab is gone — its controls (Fuzzy autocomplete and custom Numista Patterns) now live in the Filter Chips tab. Built-in seed rules deleted; custom patterns are always-on. New users get an American Silver Eagle pattern pre-seeded.</li>
