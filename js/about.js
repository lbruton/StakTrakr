...
const getEmbeddedWhatsNew = () => {
  return `
    <li><strong>v3.35.55 &ndash; STRK-240: Junk-silver weight cells filter by weight, not face value</strong>: Clicking a constitutional (junk-silver) row's Weight cell now creates a filter chip keyed on the silver troy ounces shown in the cell, not its dollar face value &mdash; so filtering a $10-face bag no longer also sweeps in unrelated 10&nbsp;oz items. The face value still lives in the cell's hover tooltip. This refines the v3.35.54 behavior, which keyed the filter on the face value and could match same-numbered weights (STRK-240).</li>
