...
const getEmbeddedWhatsNew = () => {
  return `
    <li><strong>v3.35.66 &ndash; STRK-269: Metal-ratio statistics groundwork</strong>: Lays the computational foundation for the upcoming Metal Ratios panel &mdash; the app can now build full historical ratio series (gold:silver back to 1968; gold:platinum, gold:palladium, and platinum:palladium back to 1990) and compute their long-run mean, median, all-time percentile, trailing session averages, and 52-week and all-time extremes. No visible UI yet; the panel itself arrives in an upcoming update (STRK-269).</li>
