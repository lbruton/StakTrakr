...
**Theme:** The app supports light, dark, slate, and sepia modes via `data-theme`. Dark mode uses deep navy (`#0f172a`); light mode uses a slate/blue-gray palette. The PWA theme is `#1a1a2e`.
